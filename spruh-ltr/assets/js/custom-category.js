...
const cloneFT = () => {
  ...
  formBlock.className = 'form-block mt-5 mt-md-3';
  ...
  divFtAr.className = 'ft-ar form-group m-3';
  ...
  divFtTr.className = 'ft-tr form-group m-3';
  ...
  divFnAr.className = 'fn-ar form-group m-3';
  ...
  divFnTr.className = 'fn-tr form-group m-3';
